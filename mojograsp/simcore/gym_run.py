...
def main():
    ...
    run_pybullet(overall_path+'/demos/rl_demo/data/ja_entropy_control/experiment_config.json', runtype='run')

    # run_pybullet(overall_path+'/demos/rl_demo/data/ja_more_entropy/experiment_config.json',runtype='eval')
