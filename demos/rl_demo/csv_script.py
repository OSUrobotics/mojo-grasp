...
upper_names = ['N_mothra_slide_rerun', 'J_HPC_rerun', 'N_HPC_slide_rerun']
...
for pol in names:
    ...
    temp.try_fuckery(a_path,b_path,[0.01,1000],pol+'_merged.csv')#, '/home/mothra/mojo-grasp/demos/rl_demo/data/'+pol+'_merged.csv')
