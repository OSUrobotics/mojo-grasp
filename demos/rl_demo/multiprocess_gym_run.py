...
if __name__ == '__main__':
    ...
    replay('/home/ubuntu/Mojograsp/mojo-grasp/demos/rl_demo/data/straight_finger/experiment_config.json',"/media/ubuntu/New Volume/data/Shape_Baselines/hourglass/Eval_A/Episode_206.pkl")
